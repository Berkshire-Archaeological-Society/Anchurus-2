...
def user_authentication():
  ...
  msg = "Login connection from " + ip_address + ", User " + str(Global_email)
...
def row_update(table_name,items):
  ...
  items["DBAcontrol"] = check_DBAcontrol(Global_email,"e",description)
  #logmsg("INFO",items)
  message = "OK"
...
def site_update(site_items):
  ...
  site_items["DBAcontrol"] = check_DBAcontrol(Global_email,"e",descrtiption)
...
def area_update(area_items):
  ...
  area_items["DBAcontrol"] = check_DBAcontrol(Global_email,"e",description)
  #logmsg("INFO",site_items)
  message = "OK"
...
def context_update(context_items):
  ...
  context_items["DBAcontrol"] = check_DBAcontrol(Global_email,"e",description)
...
def find_update(find_items):
  ...
  find_items["DBAcontrol"] = check_DBAcontrol(Global_email,"e",description)
...
def row_add(table_name,items):
  ...
  items["DBAcontrol"] = check_DBAcontrol(Global_email,"i",description)
  #logmsg("INFO",items)
  message = "OK"
  # need to limit variables to limit of size of databae fields, e.g. FieldDescription is less than to 65535 chars
  # put context_items dictionay into a pandas dataframe, i.e. a one row table
...
def site_add(site_items):
  ...
  site_items["DBAcontrol"] = check_DBAcontrol(Global_email,"i",description)
  #logmsg("INFO",site_items)
  message = "OK"
  # need to limit variables to limit of size of databae fields, e.g. FieldDescription is less than to 65535 chars
  # put context_items dictionay into a pandas dataframe, i.e. a one row table
...
def area_add(area_items):
  ...
  area_items["DBAcontrol"] = check_DBAcontrol(Global_email,"i",description)
...
def find_add(find_items):
  ...
  find_items["DBAcontrol"] = check_DBAcontrol(Global_email,"i",description)
  #logmsg("INFO",find_items)
  message = "OK"
  #print(find_items)
  # need to limit variables to limit of size of databae fields, e.g. FieldDescription is less than to 65535 chars
...
def context_add(context_items):
  ...
  context_items["DBAcontrol"] = check_DBAcontrol(Global_email,"i",description)
  #logmsg("INFO",context_items)
  message = "OK"
  # need to limit variables to limit of size of databae fields, e.g. FieldDescription is less than to 65535 chars
  # put context_items dictionay into a pandas dataframe, i.e. a one row table
...
def import_file(type,file):
  ...
  DBAcontrol = check_DBAcontrol(Global_email,"b",description)
